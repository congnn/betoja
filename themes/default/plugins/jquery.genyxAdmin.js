...
(function ($) {
    ...
    $.genyxAdmin = function (options) {
        return $.fn.genyxAdmin(options);
    };
    ...
    $.fn.genyxAdmin = function (options) {
        ...
        function hoverDropDown(val) {
             ...
             */(function (e, t, n) {
                e('<span class="visible-desktop" style="font-size:1px !important" id="cwspear-is-awesome">.</span>').appendTo("body");
                var r = function () {
                ...
                e.fn.dropdownHover = function (n) {
                    ...
                    return this.each(function () {
                        var s = e(this).parent(), o = {delay: 500, instantlyCloseOthers: !0}, u = {delay: e(this).data("delay"), instantlyCloseOthers: e(this).data("close-others")}, a = e.extend(!0, {}, o, n, u), f;
                        s.hover(function () {
                            if (r()) {
        ...
        function orientationFix() {
            (function (a) {
                function j() {
                    c.setAttribute("content", f), document.body.innerHTML = document.body.innerHTML, g = !0
                }
                function k() {
                    c.setAttribute("content", e), g = !1
                }
                function l(b) {
                    h = Math.abs(a.orientation), i = Math.abs(b.accelerationIncludingGravity.x), i > 8 && h === 0 ? g && k() : g || j()
                }
                var b = a.document;
                if (!b.querySelectorAll)
                    return;
                var c = b.querySelectorAll("meta[name=viewport]")[0], d = c && c.getAttribute("content"), e = d + ", maximum-scale=1.0", f = d + ", maximum-scale=10.0", g = !0, h = a.orientation, i = 0;
                if (!c)
                    return;
                a.addEventListener("orientationchange", j, !1), a.addEventListener("devicemotion", l, !1)
            })(this);
        }
        ...
        function resBtn() {
            $('#header .nav-no-collapse').append('<a href="#" id="resBtn" style="display:none" class="btn btn-danger"><i class="icon16 i-menu-6"></i></a>');
            //resBtnClick();
            resBtnClick_customize();
        }
        //destroy responsive button
        function resBtnDestroy() {
            $('#header #resBtn').remove();
            //Xu ly menu tungtb
            var check = $('#collapse-nav').hasClass('collapse');
            if (check) {
                $('#collapse-nav').click();
            }
        }
        ...
        function resBtnClick_customize() {
