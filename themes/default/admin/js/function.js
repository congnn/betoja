        ...
        if (data.html) {
            ...
            for (var key in data.record_data) {
                ...
                if (inputObj.attr("type") == "checkbox") {
                    ...
                    inputObj.val(data.record_data[key]);
                    if (key == 'contactType') {
                        if (data.record_data[key] == 1) {
                            inputObj.val('Giáo viên nước ngoài');
                        }
                        if (data.record_data[key] == 2) {
                            inputObj.val('Giáo viên việt nam');
                        }
                    }
                }
            }
 ...
 * @returns {undefined}
 */
function  custom_save_form_add_response(data, form, button) {
    button.removeAttr('disabled');
    var jgrow = "error";
    if (data.state == 1) { /* Thành công */
        button.removeClass('btn-danger');
 ...
 * @returns {undefined}
 */
function  custom_save_form_edit_response(data, form, button) {
    button.removeAttr('disabled');
    var jgrow = "error";
    if (data.state == 1) { /* Thành công */
        button.removeClass('btn-danger');
...
function  save_form_add_response_unit(data, form, button) {
    button.removeAttr('disabled');
    var jgrow = "error";
    if (data.state == 1) { /* Thành công */
        button.removeClass('btn-danger');
