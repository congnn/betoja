...
CKFinder.lang['vi'] =
{
	...
	// Basket
	BasketFolder		: 'Xọt rác',
	BasketClear			: 'Dọn xọt rác',
	BasketRemove		: 'Xóa khỏi xọt rác',
	BasketOpenFolder	: 'Mở thư mục cha',
	BasketTruncateConfirm : 'Bạn có chắc muốn bỏ tất cả tập tin trong xọt rác?',
	BasketRemoveConfirm	: 'Bạn có chắc muốn bỏ tập tin "%1" khỏi xọt rác?',
	BasketRemoveConfirmMultiple	: 'Do you really want to remove %1 files from the basket?', // MISSING
	BasketEmpty			: 'Không có tập tin trong xọt rác, hãy kéo và thả tập tin vào xọt rác.',
	BasketCopyFilesHere	: 'Chép tập tin từ xọt rác',
	BasketMoveFilesHere	: 'Chuyển tập tin từ xọt rác',
